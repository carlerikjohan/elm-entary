...
*/ var _Scheduler_working = false;
    ...
    var $author$project$Main$Model = F4(function(state, quotes, correctAnswer, score) {
        return {
    ...
    var $author$project$Main$init = function(_v0) {
        return _Utils_Tuple2(A4($author$project$Main$Model, $author$project$Main$Intro, _List_Nil, {
            author: '',
            text: ''
        }, 0), $elm$core$Platform$Cmd$none);
    };
    ...
    var $author$project$Main$HttpFailure = function(a) {
        return {
            $: 'HttpFailure',
            a: a
        };
    ...
    var $author$project$Main$SetCorrectAnswer = function(a) {
        return {
            $: 'SetCorrectAnswer',
            a: a
        };
    };
    var $author$project$Main$Success = {
        $: 'Success'
    };
    ...
    var $author$project$Main$getAnswer = function(maybeQuote) {
        if (maybeQuote.$ === 'Nothing') return {
            author: '',
            text: ''
        };
        else {
            var quote = maybeQuote.a;
            return quote;
        }
    };
    var $author$project$Main$getQuoteAtIndex = F2(function(quotes, index) {
        return A2($elm$core$Array$get, index, $elm$core$Array$fromList(quotes));
    });
    ...
    var $author$project$Main$Quote = F2(function(text, author) {
        return {
            author: author,
            text: text
        };
    });
    var $author$project$Main$quoteDecoder = A3($elm$json$Json$Decode$map2, $author$project$Main$Quote, A2($elm$json$Json$Decode$field, 'text', $elm$json$Json$Decode$string), A2($elm$json$Json$Decode$field, 'author', $elm$json$Json$Decode$string));
    var $author$project$Main$quotesDecoder = $elm$json$Json$Decode$list($author$project$Main$quoteDecoder);
    var $author$project$Main$responseDecoder = A2($elm$json$Json$Decode$field, 'quotes', $author$project$Main$quotesDecoder);
    var $author$project$Main$getRandomQuotes = $elm$http$Http$get({
        expect: A2($elm$http$Http$expectJson, $author$project$Main$GotQuote, $author$project$Main$responseDecoder),
    ...
    var $author$project$Main$scoreIfRightAnswer = F3(function(score, correctAnswer, answer) {
        var _v0 = _Utils_eq(correctAnswer, answer);
        if (_v0) return score + 1;
        else return score;
    });
    ...
    var $author$project$Main$update = F2(function(msg, model) {
        switch(msg.$){
            case 'GetQuote':
                ...
                }), $author$project$Main$getRandomQuotes);
            case 'GotQuote':
                var result = msg.a;
                if (result.$ === 'Ok') {
                    ...
                    return _Utils_Tuple2(_Utils_update(model, {
                        quotes: response
                    }), A2($elm$random$Random$generate, $author$project$Main$SetCorrectAnswer, A2($elm$random$Random$int, 0, 1)));
                } else {
                    var error = result.a;
                    return _Utils_Tuple2(_Utils_update(model, {
                        state: $author$project$Main$HttpFailure($elm$core$Debug$toString(error))
                    }), $elm$core$Platform$Cmd$none);
                }
            case 'SetCorrectAnswer':
                var index = msg.a;
                return _Utils_Tuple2(_Utils_update(model, {
                    correctAnswer: $author$project$Main$getAnswer(A2($author$project$Main$getQuoteAtIndex, model.quotes, index)),
                    state: $author$project$Main$Success
                }), $elm$core$Platform$Cmd$none);
            default:
                var answer = msg.a;
                return _Utils_Tuple2(_Utils_update(model, {
                    score: A3($author$project$Main$scoreIfRightAnswer, model.score, model.correctAnswer, answer),
                    state: $author$project$Main$Loading
                }), $author$project$Main$getRandomQuotes);
        }
    });
    var $author$project$Main$GetQuote = {
        $: 'GetQuote'
    };
    ...
    var $author$project$Main$renderAnswerButton = function(quote) {
        return A2($elm$html$Html$button, _List_fromArray([
            $elm$html$Html$Events$onClick($author$project$Main$Answer(quote)),
            $elm$html$Html$Attributes$class('button')
        ]), _List_fromArray([
            $elm$html$Html$text(quote.author)
        ]));
    };
    var $author$project$Main$renderError = function(error) {
        return A2($elm$html$Html$div, _List_fromArray([
    ...
    var $author$project$Main$renderQuote = function(quote) {
        return $elm$html$Html$text(quote.text);
    };
    var $author$project$Main$view = function(model) {
        ...
        switch(_v0.$){
            ...
            case 'HttpFailure':
                var error = _v0.a;
                return $author$project$Main$renderError(error);
            case 'Loading':
            ...
            default:
                return A2($elm$html$Html$div, _List_fromArray([
                    ...
                    A2($elm$html$Html$div, _List_fromArray([
                        ...
                        $author$project$Main$renderQuote(model.correctAnswer)
                    ])),
                    A2($elm$html$Html$h2, _List_fromArray([
                        $elm$html$Html$Attributes$class('who')
                    ]), _List_fromArray([
                        $elm$html$Html$text($elm$core$String$fromInt(model.score))
                    ])),
                    A2($elm$html$Html$div, _List_fromArray([
                        $elm$html$Html$Attributes$class('buttons')
                    ]), A2($elm$core$List$map, $author$project$Main$renderAnswerButton, model.quotes))
                ]));
        }
    };
            ...
            'init': $author$project$Main$main($elm$json$Json$Decode$succeed(_Utils_Tuple0))({
                ...
                "types": {
                    ...
                    "aliases": {
                        "Main.Quote": {
                            "args": [],
                            "type": "{ text : String.String, author : String.String }"
                        }
                    },
                    "unions": {
                        "Main.Msg": {
                            ...
                            "tags": {
                                "GetQuote": [],
                                "GotQuote": [
                                    "Result.Result Http.Error (List.List Main.Quote)"
                                ],
                                "SetCorrectAnswer": [
                                    "Basics.Int"
                                ],
...
},{}]},["lBB98","hD4hw"], "hD4hw", "parcelRequire6142")
